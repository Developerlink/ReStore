    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<StoreDbContext>(options =>
            {
                ...
                if (env == "Development")
                {
                    // Use connection string from file. (local postgres)
                ...
                else
                {
                    ...
                    connStr = $"Server={pgHost};Port={pgPort};User Id={pgUser};" +
                    $"Password={pgPass};Database={pgDb};SSL Mode=Require;Trust Server Certificate=true";
                }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // This order is important. We can't authorize before 
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                // Any endpoints outside the api will be handled
                // by the fallback controller.
